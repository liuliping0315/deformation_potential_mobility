...
def hse_polyfit_emass_cbm():
    ...
    y1 = data_band.eigen[0:10,data_band.nb_cbm]
    y2 = data_band.eigen[10:20,data_band.nb_cbm]
...
if __name__ == '__main__':
    r_em1, r_em2, rs1, rs2 = hse_polyfit_emass_cbm()
    print('ele emass1: %16.8f r_square1: %16.8f' % (r_em1, rs1))
    print('ele emass2: %16.8f r_square2: %16.8f' % (r_em2, rs2))
