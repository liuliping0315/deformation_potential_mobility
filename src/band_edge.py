...
class band_calculation():
    ...
    def read_band_cal(self):
        ...
        for i in range(3):
            ...
            self.reclat[i][0:3] = np.array(txt_tmp[3:6])
        ...
        # read self.k_frac and self.eigen
    ...
    def show_eigen(self, ki, bi):
        print('eigenvalue at (kpt_number, band_number) is. eigen_shifted(%d,%d)=%12.6f' % (ki, bi, self.eigen_shifted[ki, bi]))
    ...
    def output(self):
        ...
        print('(kl_cart, CBM-Fermi)= %8.4f %8.4f' % (self.klc, self.e_cbm))
        print('(kl_cart, VBM-Fermi)= %8.4f %8.4f' % (self.klv, self.e_vbm))
        print('(kl_frac, CBM-Fermi)= %8.4f %8.4f' % (self.klcf, self.e_cbm))
        print('(kl_frac, VBM-Fermi)= %8.4f %8.4f' % (self.klvf, self.e_vbm))
